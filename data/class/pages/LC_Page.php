...
/*
GC_Utils_Ex::gfDebugLog("-----test-----",DATA_PATH.'logs/test.log',true);
GC_Utils_Ex::gfDebugLog($_SERVER['REQUEST_URI'],DATA_PATH.'logs/test.log',true);
GC_Utils_Ex::gfDebugLog($_SERVER['PHP_SELF'],DATA_PATH.'logs/test.log',true);
GC_Utils_Ex::gfDebugLog("-----test end-----",DATA_PATH.'logs/test.log',true);
*/
        // 開始時刻を設定する。
       ...
       $force_login_page = array(
        ...
        if( $_SERVER['REQUEST_URI'] != "/" && $_SERVER['PHP_SELF'] != "/index.php" && $this->str_match_array( $_SERVER['PHP_SELF'], $force_login_page ) === false ){
            return true;
        }
     ...
     */
    private function str_match_array( $haystack, $needle_array ) {
