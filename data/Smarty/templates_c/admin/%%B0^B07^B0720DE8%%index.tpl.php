<?php /* Smarty version 2.6.27, created on 2014-12-03 00:18:23
         compiled from system/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'system/index.tpl', 4, false),array('modifier', 'h', 'system/index.tpl', 33, false),)), $this); ?>
...
"><div id="system" class="contents-main">
        ...
        <div class="btn">
            <a class="btn-action" href="javascript:;" onclick="eccube.openWindow('./input.php','input','620','750'); return false;"><span class="btn-next">メンバーを新規入力</span></a>
        </div>
        <!--▼メンバー一覧ここから-->
        <table class="list"><!--
            <col width="15%" />
...
--><tr><th>権限</th>
                ...
                <th>削除</th>
                <th>移動</th>
            </tr><?php unset($this->_sections['data']);
...
<?php endif; ?>
                ...
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['list_data'][$this->_sections['data']['index']]['agency_code'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
...
">下へ</a><?php endif; ?>
            ...
            </tr><!--▲メンバー <?php echo ((is_array($_tmp=$this->_sections['data']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
 --><?php endfor; endif; ?></table><div class="paging">
            <!--▼ページ送り-->
            <?php echo ((is_array($_tmp=$this->_tpl_vars['tpl_strnavi'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
