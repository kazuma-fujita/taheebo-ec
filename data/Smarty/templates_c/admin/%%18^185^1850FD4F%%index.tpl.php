<?php /* Smarty version 2.6.27, created on 2014-12-03 01:03:02
         compiled from customer/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/index.tpl', 38, false),array('modifier', 'h', 'customer/index.tpl', 55, false),array('function', 'html_checkboxes', 'customer/index.tpl', 42, false),array('function', 'html_options', 'customer/index.tpl', 45, false),array('function', 'mailto', 'customer/index.tpl', 84, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="search"><h2>検索条件設定</h2>
        ...
        <!--検索条件設定テーブルここから-->
        <table class="form"><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?><?php if (false): ?><tr><th>会員状態</th>
            ...
            </tr><?php endif; ?></table><div class="btn">
            <p class="page_rows">検索結果表示件数
            <select name="search_page_max"><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrPageMax'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['search_page_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</select> 件</p>
            <div class="btn-area">
    ...
    <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrErr'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) == 0 && ( ((is_array($_tmp=$_POST['mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'search' || ((is_array($_tmp=$_POST['mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'delete' || ((is_array($_tmp=$_POST['mode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'resend_mail' )): ?>
        ...
        <form name="form1" id="form1" method="post" action="?">
            <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value="search"><input type="hidden" name="edit_customer_id" value=""><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrHidden'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <!--検索結果表示テーブル-->
            <table class="list" id="customer-search-result"><col width="8%"><col width="10%"><col width="30%"><col width="8%"><col width="30%"><col width="7%"><col width="7%"><tr><th rowspan="2">種別</th>
                    <th>会員ID</th>
                    ...
                    <th>メールアドレス</th>
                </tr><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrData'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['row']):
?><tr><td class="center" rowspan="2"><?php if (((is_array($_tmp=$this->_tpl_vars['row']['status'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?>仮<?php else: ?>本<?php endif; ?></td>
...
');">削除</a></span></td>
                    </tr><tr><td><?php $this->assign('pref', ((is_array($_tmp=$this->_tpl_vars['row']['pref'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))); ?><?php echo ((is_array($_tmp=$this->_tpl_vars['arrPref'][$this->_tpl_vars['pref']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
...
');">仮登録メール再送</a><?php endif; ?></td>
                    </tr><?php endforeach; endif; unset($_from); ?></table><!--検索結果表示テーブル--><?php endif; ?></form>
        <!--★★検索結果一覧★★-->
