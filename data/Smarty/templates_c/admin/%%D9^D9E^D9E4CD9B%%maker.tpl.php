<?php /* Smarty version 2.6.27, created on 2014-09-03 10:14:59
         compiled from products/maker.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/maker.tpl', 26, false),array('modifier', 'h', 'products/maker.tpl', 37, false),array('function', 'sfSetErrorStyle', 'products/maker.tpl', 37, false),)), $this); ?>
        ...
        <table class="form">
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="name" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['name']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
<?php endif; ?>;">
                ...
                <td class="center">
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('pre_edit', 'maker_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrMaker'][$this->_sections['cnt']['index']]['maker_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">編集</a>
                    <?php else: ?>
                    編集中
                    <?php endif; ?>
                ...
                <td class="center">
                    ...
                    -
                    <?php else: ?>
                    <a href="?" onclick="eccube.setModeAndSubmit('delete', 'maker_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrMaker'][$this->_sections['cnt']['index']]['maker_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">削除</a>
                    <?php endif; ?>
                </td>
                <td class="center">
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('up', 'maker_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrMaker'][$this->_sections['cnt']['index']]['maker_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">上へ</a>
                    <?php endif; ?>
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('down', 'maker_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrMaker'][$this->_sections['cnt']['index']]['maker_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">下へ</a>
                    <?php endif; ?>
                </td>
            </tr>
