<?php /* Smarty version 2.6.27, created on 2014-09-03 16:11:55
         compiled from products/classcategory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/classcategory.tpl', 26, false),array('modifier', 'h', 'products/classcategory.tpl', 30, false),array('modifier', 'sfGetErrorColor', 'products/classcategory.tpl', 45, false),)), $this); ?>
...
" />
    ...
    <div id="products" class="contents-main">
        ...
        <table>
            <tr>
                <th>規格名</th>
                <td><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_class_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</td>
            </tr>
            <tr>
...
<?php endif; ?>;">
                    ...
                    <td align="center" >
                        <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ((is_array($_tmp=$this->_tpl_vars['arrClassCat'][$this->_sections['cnt']['index']]['classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                            <a href="?" onclick="eccube.setModeAndSubmit('pre_edit','classcategory_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrClassCat'][$this->_sections['cnt']['index']]['classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">編集</a>
                        <?php else: ?>
                            編集中
                        <?php endif; ?>
                    ...
                    <td align="center">
                        <a href="?" onclick="if(window.confirm('分類名を削除すると、その分類を利用している商品規格が無効になります。\n整合性の問題を把握し、バックアップを行ってから削除することを推奨致します。')){ eccube.setModeAndSubmit('delete','classcategory_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrClassCat'][$this->_sections['cnt']['index']]['classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); } return false;">削除</a>
                    </td>
                    <td align="center">
                        <?php if (((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != 1): ?>
                            <a href="?" onclick="eccube.setModeAndSubmit('up','classcategory_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrClassCat'][$this->_sections['cnt']['index']]['classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">上へ</a>
                        <?php endif; ?>
                        <?php if (((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ((is_array($_tmp=$this->_sections['cnt']['last'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                            <a href="?" onclick="eccube.setModeAndSubmit('down','classcategory_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrClassCat'][$this->_sections['cnt']['index']]['classcategory_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">下へ</a>
                        <?php endif; ?>
                    </td>
                </tr>
