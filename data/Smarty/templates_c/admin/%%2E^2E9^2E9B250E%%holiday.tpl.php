<?php /* Smarty version 2.6.27, created on 2014-09-03 14:23:28
         compiled from basis/holiday.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/holiday.tpl', 26, false),array('modifier', 'h', 'basis/holiday.tpl', 36, false),array('modifier', 'sfGetErrorColor', 'basis/holiday.tpl', 36, false),array('function', 'html_options', 'basis/holiday.tpl', 50, false),)), $this); ?>
        ...
        <table class="form">
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="title" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['title']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
日</td>
                <td class="center">
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('pre_edit', 'holiday_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">編集</a>
                    <?php else: ?>
                    編集中
                    <?php endif; ?>
                ...
                <td class="center">
                    ...
                    -
                    <?php else: ?>
                    <a href="?" onclick="eccube.setModeAndSubmit('delete', 'holiday_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">削除</a>
                    <?php endif; ?>
                </td>
                <td class="center">
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('up', 'holiday_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">上へ</a>
                    <?php endif; ?>
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('down', 'holiday_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrHoliday'][$this->_sections['cnt']['index']]['holiday_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">下へ</a>
                    <?php endif; ?>
                </td>
            </tr>
