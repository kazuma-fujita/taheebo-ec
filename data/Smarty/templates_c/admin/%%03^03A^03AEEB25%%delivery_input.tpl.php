<?php /* Smarty version 2.6.27, created on 2014-09-03 09:54:26
         compiled from basis/delivery_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/delivery_input.tpl', 26, false),array('modifier', 'h', 'basis/delivery_input.tpl', 29, false),array('modifier', 'sfGetErrorColor', 'basis/delivery_input.tpl', 39, false),array('function', 'html_radios', 'basis/delivery_input.tpl', 99, false),array('function', 'html_checkboxes', 'basis/delivery_input.tpl', 113, false),)), $this); ?>
...
">
        ...
        <h2>配送料登録</h2>
        <div class="btn">※全国一律送料 <input type="text" name="fee_all" class="box10" /> 円に設定する　<a class="btn-normal" href="javascript:;" onclick="eccube.setDelivFee(<?php echo ((is_array($_tmp=@DELIVFEE_MAX)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
