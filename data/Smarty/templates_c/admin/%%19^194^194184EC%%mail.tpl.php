<?php /* Smarty version 2.6.27, created on 2014-09-03 10:07:40
         compiled from order/mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'order/mail.tpl', 26, false),array('modifier', 'h', 'order/mail.tpl', 32, false),array('modifier', 'sfDispDBDate', 'order/mail.tpl', 50, false),array('modifier', 'sfGetErrorColor', 'order/mail.tpl', 65, false),array('function', 'html_options', 'order/mail.tpl', 67, false),)), $this); ?>
...
?>
            <tr class="center">
                ...
                <td><a href="?" onclick="eccube.openWindow('./mail_view.php?send_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['arrMailHistory'][$this->_sections['cnt']['index']]['send_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" onchange="eccube.setModeAndSubmit('change', '', '');">
