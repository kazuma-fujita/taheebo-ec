<?php /* Smarty version 2.6.27, created on 2014-09-03 11:38:44
         compiled from mail/history.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/history.tpl', 26, false),array('modifier', 'sfDispDBDate', 'mail/history.tpl', 48, false),array('modifier', 'h', 'mail/history.tpl', 48, false),)), $this); ?>
...
?>
                <tr>
                    ...
                    <td><a href="javascript:;" onclick="eccube.openWindow('./preview.php?mode=history&amp;send_id=<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrDataList'][$this->_sections['cnt']['index']]['send_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
', 'confirm', '720', '600', {menubar:'no'}); return false;">確認</a></td>
                    <td><a href="javascript:;" onclick="eccube.openWindow('./<?php echo ((is_array($_tmp=@DIR_INDEX_PATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
','query','615','800',{menubar:'no'}); return false;">確認</a></td>
