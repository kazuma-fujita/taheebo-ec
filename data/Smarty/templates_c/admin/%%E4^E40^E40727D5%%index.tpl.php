<?php /* Smarty version 2.6.27, created on 2014-12-03 01:03:04
         compiled from basis/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/index.tpl', 85, false),array('modifier', 'h', 'basis/index.tpl', 91, false),array('modifier', 'sfGetErrorColor', 'basis/index.tpl', 168, false),array('function', 'html_options', 'basis/index.tpl', 123, false),array('function', 'html_checkboxes', 'basis/index.tpl', 180, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="confirm"><div id="basis" class="contents-main">

        <h2>基本情報</h2>
        <table summary="基本情報" id="basis-index-basis"><tr><th>会社名</th>
                <td>
...
文字)</span>
            ...
            </tr><tr><th>店名<span class="attention"> *</span></th>
                <td>
...
;<?php endif; ?>"><span class="attention"> (上限<?php echo ((is_array($_tmp=@MTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
                </td>
            </tr><tr><th>郵便番号<span class="attention"> *</span></th>
                <td>
...
;<?php endif; ?>"><a class="btn-normal" href="javascript:;" name="address_input" onclick="eccube.getAddress('<?php echo ((is_array($_tmp=@INPUT_ZIP_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
', 'zip01', 'zip02', 'pref', 'addr01'); return false;">所在地入力</a>
                </td>
            </tr><tr><th>SHOP所在地<span class="attention"> *</span></th>
                <td>
                    <p>
...
;<?php endif; ?>"><option value="" selected>都道府県を選択</option><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrPref'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['pref'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</select></p>
                    <p>
...
文字)</span><br><?php echo ((is_array($_tmp=@SAMPLE_ADDRESS1)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</p>
                    <p>
...
文字)</span><br><?php echo ((is_array($_tmp=@SAMPLE_ADDRESS2)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</p>
                </td>
            </tr><tr><th>TEL</th>
                <td>
...
文字)</span>
            ...
            </tr><tr><th>商品注文受付<br>メールアドレス<span class="attention"> *</span></th>
                <td>
...
;<?php endif; ?>"></td>
            </tr><tr><th>問い合わせ受付<br>メールアドレス<span class="attention"> *</span></th>
                <td>
...
;<?php endif; ?>"></td>
            </tr><tr><th>メール送信元<br>メールアドレス<span class="attention"> *</span></th>
                <td>
...
;<?php endif; ?>"></td>
            </tr><tr><th>送信エラー受付<br>メールアドレス<span class="attention"> *</span></th>
                <td>
...
</textarea><span class="attention"> (上限<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
                </td>
            </tr><tr><th>メッセージ</th>
                <td>
...
文字)</span>
            ...
            </tr></table><h2>定休日設定</h2>
        <table id="basis-index-holiday"><tr><th>定休日</th>
                <td>
            ...
            </tr></table><h2>SHOP機能</h2>
        <table id="basis-index-func"><tr><th>送料無料条件</th>
                <td>
...
;<?php endif; ?>" id="longitude"><a class="btn-normal" href="javascript:;" name="codeAddress" id="codeAddress" onclick="">所在地より自動取得</a>
                    <a href="#maparea" id="mapAddress">地図で設定</a>
                </td>
            </tr></table><div class="btn-area">
            <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.submitForm(); return false;"><span class="btn-next">確認ページへ</span></a></li>
            </ul></div>
    </div>
    <div style="display: none">
        <div id="maparea">
            ...
            <div class="btn-area">
                <ul><li><a class="btn-normal" href="javascript:;" id="inputPoint">この位置を入力</a></li>
                </ul></div>
        </div>
    </div>
