<?php /* Smarty version 2.6.27, created on 2014-10-05 18:00:44
         compiled from total/page_products.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'total/page_products.tpl', 36, false),array('modifier', 'h', 'total/page_products.tpl', 49, false),array('modifier', 'sfCutString', 'total/page_products.tpl', 50, false),array('modifier', 'number_format', 'total/page_products.tpl', 53, false),)), $this); ?>
...
件</td>
            ...
            <td class="right"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrResults'][$this->_sections['cnt']['index']]['price'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
円</td>
