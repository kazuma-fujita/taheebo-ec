<?php /* Smarty version 2.6.27, created on 2014-12-03 00:17:32
         compiled from design/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/index.tpl', 3, false),array('modifier', 'h', 'design/index.tpl', 3, false),array('modifier', 'strlen', 'design/index.tpl', 225, false),)), $this); ?>
...
"><div id="design" class="contents-main">
        ...
        <div style="float: left; width: 75%;" align="center">
            <table id="design-layout-used" class="design-layout"><tr><th colspan="3">&lt;head&gt;</th>
                </tr><tr><!-- ★☆★ HEADタグ内テーブル ☆★☆ --><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_HEAD])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                                </div>
                    ...
                    <!-- ★☆★ Headタグ内テーブル ☆★☆ -->
                </tr><tr><th colspan="3">&lt;/head&gt;</th>
                </tr><tr><!-- ★☆★ ヘッダより上部ナビテーブル ☆★☆ --><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_HEAD_TOP])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                        <?php $this->assign('firstflg', false); ?>
                        <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    <!-- ★☆★ ヘッダより上部ナビテーブル ☆★☆ -->
                </tr><tr><!-- ★☆★ ヘッダ内部ナビテーブル ☆★☆ --><th id="layout-header">ヘッダー部</th>
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    <!-- ★☆★ ヘッダ内部ナビテーブル ☆★☆ -->
                </tr><tr><!-- ★☆★ 上部ナビテーブル ☆★☆ --><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_TOP])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                        <?php $this->assign('firstflg', false); ?>
                        <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    </tr><tr><th colspan="3" id="layout-main">メイン</th>
                    </tr><tr><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_MAIN_FOOT])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                            <?php $this->assign('firstflg', false); ?>
                            <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    </tr><?php else: ?><tr><td rowspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_LEFT])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                            <?php $this->assign('firstflg', false); ?>
                            <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    </tr><tr><th id="layout-main">メイン</th>
                    </tr><tr><td id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_MAIN_FOOT])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                            <?php $this->assign('firstflg', false); ?>
                            <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    </tr><?php endif; ?><tr><!-- ★☆★ 下部ナビテーブル ☆★☆ --><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_BOTTOM])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                        <?php $this->assign('firstflg', false); ?>
                        <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                    ...
                    <!-- ★☆★ 下部ナビテーブル ☆★☆ -->
                </tr><tr><th colspan="3" id="layout-footer">フッター部</th>
                </tr><tr><!-- ★☆★ フッタより下部ナビテーブル ☆★☆ --><td colspan="3" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_FOOTER_BOTTOM])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="ui-sortable">
                        <?php $this->assign('firstflg', false); ?>
                        <?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrBlocs'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['bloc_loop'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['bloc_loop']['total'] > 0):
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
        ...
        <div style="float: left; width: 25%;" align="center">
            <table id="design-layout-unused" class="design-layout"><tr><th>未使用ブロック</th>
                </tr><tr><td id="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrTarget'][@TARGET_ID_UNUSED])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['item']['anywhere'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?> checked <?php endif; ?>>全ページ)</label>
                ...
                </tr></table><div class="btn"><a class="btn-normal" href="javascript:;" onclick="fnTargetSelf(); eccube.fnFormModeSubmit('form1','new_bloc','',''); return false;"><span>ブロックを新規入力</span></a></div>
        </div>
        
            <div class="btn-area">
                <ul><?php if (((is_array($_tmp=$this->_tpl_vars['device_type_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@DEVICE_TYPE_PC)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><li><a class="btn-action" href="javascript:;" name="preview" onclick="doPreview();"><span class="btn-prev">プレビュー</span></a></li>
                <?php endif; ?>
        ...
        </tr><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrEditPage'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
...
'); return false;">削除</a>
            ...
            </tr><?php endforeach; endif; unset($_from); ?></table><!--▲ページ一覧　ここまで--></div>
</form>