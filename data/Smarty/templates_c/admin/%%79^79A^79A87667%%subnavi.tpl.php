<?php /* Smarty version 2.6.27, created on 2014-12-03 00:17:28
         compiled from /var/www/eccube/html/../data/Smarty/templates/admin/ownersstore/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube/html/../data/Smarty/templates/admin/ownersstore/subnavi.tpl', 3, false),)), $this); ?>
...
"><span>プラグイン管理</span></a>
        <ul class="level2"><li id="navi-ownersstore-index" class="<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_subno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'index'): ?>on<?php endif; ?>">
