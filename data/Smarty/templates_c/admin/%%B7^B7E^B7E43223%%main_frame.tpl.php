...
smarty_core_load_plugins(array('plugins' => array(array('function', 'printXMLDeclaration', 'main_frame.tpl', 1, false),array('modifier', 'script_escape', 'main_frame.tpl', 5, false),array('modifier', 'count', 'main_frame.tpl', 37, false),array('modifier', 'h', 'main_frame.tpl', 77, false),array('modifier', 'sfDispDBDate', 'main_frame.tpl', 78, false),array('modifier', 'date_format', 'main_frame.tpl', 149, false),)), $this); ?>
...
img/header/logo.jpg" width="172" height="25" alt="EC-CUBE"></a></div>
        <div id="site-check">
            <p class="info"><span><strong>ログイン : </strong><?php if (((is_array($_tmp=$_SESSION['agency_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$_SESSION['agency_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
<?php else: ?><?php echo ((is_array($_tmp=((is_array($_tmp=$_SESSION['login_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
<?php endif; ?></span> 様,  
...
" class="btn-tool-format" target="_blank"><span>SITE CHECK</span></a></li--><li><a href="<?php echo ((is_array($_tmp=@HTTP_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php echo ((is_array($_tmp=@DIR_INDEX_PATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="btn-tool-format" target="_blank"><span>サイトを見る</span></a></li>
...
<?php if (((is_array($_tmp=$_SESSION['authority'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?>
    <ul id="navi" class="clearfix"><li id="navi-basis" class="<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_mainno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'basis'): ?>on<?php endif; ?>">
