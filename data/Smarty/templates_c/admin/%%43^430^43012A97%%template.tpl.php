<?php /* Smarty version 2.6.27, created on 2014-11-10 04:00:41
         compiled from design/template.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/template.tpl', 39, false),array('modifier', 'h', 'design/template.tpl', 42, false),)), $this); ?>
...
/</td>
                <td><span class="icon_confirm"><a href="javascript:;" onclick="eccube.fnFormModeSubmit('form2', 'download','template_code','<?php echo ((is_array($_tmp=$this->_tpl_vars['tplcode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
');return false;">ダウンロード</a></span></td>
                <td><span class="icon_delete"><a href="javascript:;" onclick="eccube.fnFormModeSubmit('form2', 'delete','template_code','<?php echo ((is_array($_tmp=$this->_tpl_vars['tplcode'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
