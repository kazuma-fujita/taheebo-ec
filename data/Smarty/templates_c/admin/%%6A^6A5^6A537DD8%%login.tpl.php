<?php /* Smarty version 2.6.27, created on 2014-12-03 00:17:25
         compiled from login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'login.tpl', 7, false),array('modifier', 'date_format', 'login.tpl', 18, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="login"><p><label for="login_id">ID</label></p>
                ...
                <input type="password" name="password" size="20" class="box25"><p><a class="btn-tool-format" href="javascript:;" onclick="document.form1.submit(); return false;"><span>LOGIN</span></a></p>
            </form>
        </div>
    </div>
