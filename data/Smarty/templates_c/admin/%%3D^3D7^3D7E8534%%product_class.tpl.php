<?php /* Smarty version 2.6.27, created on 2014-09-03 16:11:36
         compiled from products/product_class.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/product_class.tpl', 35, false),array('modifier', 'h', 'products/product_class.tpl', 114, false),array('modifier', 'default', 'products/product_class.tpl', 200, false),array('modifier', 'sfGetErrorColor', 'products/product_class.tpl', 314, false),array('function', 'html_options', 'products/product_class.tpl', 142, false),array('function', 'sfSetErrorStyle', 'products/product_class.tpl', 251, false),)), $this); ?>
...
(円)<span class="attention">*</span></th>
                <?php if (((is_array($_tmp=@OPTION_PRODUCT_TAX_RULE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
...
" />
                            <a href="?" onclick="eccube.fnFormModeSubmit('form1', 'file_delete', 'upload_index', '<?php echo ((is_array($_tmp=$this->_tpl_vars['index'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" /><br />
                        <a class="btn-normal" href="javascript:;" name="btn" onclick="eccube.fnFormModeSubmit('form1', 'file_upload', 'upload_index', '<?php echo ((is_array($_tmp=$this->_tpl_vars['index'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
