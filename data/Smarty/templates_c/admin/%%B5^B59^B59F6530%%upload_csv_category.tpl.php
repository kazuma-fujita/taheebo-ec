<?php /* Smarty version 2.6.27, created on 2014-10-07 01:26:58
         compiled from products/upload_csv_category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/upload_csv_category.tpl', 27, false),)), $this); ?>
        ...
        <table class="form">
            <tr>
                ...
                <td>
                    ...
                    (最大アップロードサイズ:<?php echo ((is_array($_tmp=$this->_tpl_vars['max_upload_csv_size'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)</span>
                </td>
            </tr>
            <tr>
