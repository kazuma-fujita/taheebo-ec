<?php /* Smarty version 2.6.27, created on 2014-09-01 22:35:14
         compiled from design/css.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'design/css.tpl', 26, false),array('modifier', 'h', 'design/css.tpl', 28, false),array('modifier', 'sfGetErrorColor', 'design/css.tpl', 45, false),)), $this); ?>
...
">編集</a>
                ...
                <td class="center" style="background:<?php if (((is_array($_tmp=$this->_tpl_vars['item']['css_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=$this->_tpl_vars['css_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><?php echo ((is_array($_tmp=@SELECT_RGB)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php else: ?>#ffffff<?php endif; ?>;">
                    <a href="javascript:;" onclick="eccube.fnFormModeSubmit('form_css','delete','css_name','<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['css_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
'); return false;">削除</a>
                </td>
            </tr>
