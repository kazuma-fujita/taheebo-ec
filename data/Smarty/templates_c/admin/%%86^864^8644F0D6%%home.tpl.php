...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'home.tpl', 8, false),array('modifier', 'sfDispDBDate', 'home.tpl', 11, false),array('modifier', 'h', 'home.tpl', 11, false),array('modifier', 'default', 'home.tpl', 32, false),array('modifier', 'number_format', 'home.tpl', 32, false),)), $this); ?>
...
?>
            ...
            </dl><?php endforeach; endif; unset($_from); ?><?php endif; ?></div>
<?php endif; ?>
...
"><?php if (false): ?><?php if (((is_array($_tmp=$_SESSION['authority'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 0): ?><h2>システム情報</h2>
            <table summary="システム情報" class="shop-info"><tr><th>EC-CUBEバージョン</th>
...
system/system.php">システム設定＞システム情報</a></td>
                </tr></table><?php endif; ?><?php endif; ?><h2>ショップの状況</h2>
            <table summary="ショップの状況" class="shop-info"><tr><th>現在の会員数</th>
...
件</td>
                </tr><tr><th><span>今月の売上高</span><span>(使用pt)</span></th>
...
件</td>
                </tr><?php if (false): ?><tr><th>品切れ商品</th>
                    <td>
...
<br><?php endfor; endif; ?></td>
                </tr><?php endif; ?></table><h2>新規受付一覧</h2>
            <table summary="新規受付一覧" id="home-order"><tr><th class="center">受注日</th>
...
$this->_sections['i']['first']      = ($this->_sections['i']['iteration'] == 1);
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?><tr><td><?php echo ((is_array($_tmp=$this->_tpl_vars['arrNewOrder'][$this->_sections['i']['index']]['create_date'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
...
pt</td>
                </tr><?php endfor; endif; ?></table></form>
    </div>
