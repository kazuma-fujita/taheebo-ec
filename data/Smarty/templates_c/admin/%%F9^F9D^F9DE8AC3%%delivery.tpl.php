<?php /* Smarty version 2.6.27, created on 2014-09-03 09:54:23
         compiled from basis/delivery.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/delivery.tpl', 26, false),array('modifier', 'h', 'basis/delivery.tpl', 51, false),)), $this); ?>
...
?>
                <tr>
                    ...
                    <td align="center"><a href="?" onclick="eccube.changeAction('./delivery_input.php'); eccube.setModeAndSubmit('pre_edit', 'deliv_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">
                        編集</a></td>
                    <td align="center"><a href="?" onclick="eccube.setModeAndSubmit('delete', 'deliv_id', <?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
); return false;">
                        削除</a></td>
                    <td align="center">
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('up','deliv_id', '<?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">上へ</a>
                    <?php endif; ?>
                    ...
                    <a href="?" onclick="eccube.setModeAndSubmit('down','deliv_id', '<?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">下へ</a>
                    <?php endif; ?>
                    </td>
                </tr>
