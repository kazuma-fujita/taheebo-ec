<?php /* Smarty version 2.6.27, created on 2014-09-02 23:18:18
         compiled from /var/www/eccube/html/../data/Smarty/templates/admin/products/product_rank_tree_fork.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube/html/../data/Smarty/templates/admin/products/product_rank_tree_fork.tpl', 23, false),array('modifier', 'sfCutString', '/var/www/eccube/html/../data/Smarty/templates/admin/products/product_rank_tree_fork.tpl', 35, false),array('modifier', 'h', '/var/www/eccube/html/../data/Smarty/templates/admin/products/product_rank_tree_fork.tpl', 35, false),)), $this); ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => (@TEMPLATE_ADMIN_REALDIR)."products/product_rank_tree_fork.tpl", 'smarty_include_vars' => array('children' => ((is_array($_tmp=$this->_tpl_vars['child']['children'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'treeID' => "f".($this->_tpl_vars['child']['category_id']),'display' => ((is_array($_tmp=$this->_tpl_vars['disp_child'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))));
