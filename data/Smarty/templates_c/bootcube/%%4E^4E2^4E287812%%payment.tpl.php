<?php /* Smarty version 2.6.27, created on 2014-11-11 16:38:52
         compiled from /var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 36, false),array('modifier', 'h', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 125, false),array('modifier', 'sfGetErrorColor', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 152, false),array('modifier', 'sfGetChecked', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 152, false),array('modifier', 'nl2br', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 155, false),array('modifier', 'default', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 222, false),array('modifier', 'number_format', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 244, false),array('function', 'html_options', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/payment.tpl', 223, false),)), $this); ?>
...
img/picture/img_flow_02.jpg" class="img-responsive" alt="購入手続きの流れ" />
		</p>
...
<?php if (((is_array($_tmp=$this->_tpl_vars['arrDeliv'][$this->_sections['cnt']['index']]['remark'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><p><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrDeliv'][$this->_sections['cnt']['index']]['remark'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
			...
			<div class="pay_area">
				...
				<?php endif; ?>
				<table class="table table-bordered" summary="お支払方法選択" id="payment">
					<col width="10%" />
					<col width="60%" />
					<thead>
						<tr>
							<th class="alignC">選択</th>
							<th colspan="<?php if (! ((is_array($_tmp=$this->_tpl_vars['img_show'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>2<?php else: ?>3<?php endif; ?>" id="payment_method">お支払方法</th>
						</tr>
					</thead>
					<tbody>
						<?php unset($this->_sections['cnt']);
 ...
 onclick="eccube.togglePointForm();" /><label for="point_off">　ポイントを使用しない</label></li>
			...
			<div class="btn_area">
				<ul class="list-inline">
					...
					<li>
						<input type="submit" class="btn btn-primary" value="次へ" name="next" id="next" />
					</li>
				</ul>
			</div>
		</form>
