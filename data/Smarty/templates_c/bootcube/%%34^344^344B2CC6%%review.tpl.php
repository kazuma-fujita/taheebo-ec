<?php /* Smarty version 2.6.27, created on 2014-09-03 09:36:18
...
" class="box350" /></td>
			...
			<tr>
				...
				<td>
					...
					<select class="recommend_level" name="recommend_level" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['recommend_level'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
">
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
		...
		<div class="btn_area">
			<ul class="list-inline">
				<li><input type="submit" value="確認ページへ" class="btn btn-default" name="conf" id="conf" /></li>
			</ul>
		</div>
	</form>
</div>
