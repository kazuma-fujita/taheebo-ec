<?php /* Smarty version 2.6.27, created on 2014-09-03 15:07:08
         compiled from forgot/secret.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'forgot/secret.tpl', 28, false),array('modifier', 'escape', 'forgot/secret.tpl', 28, false),array('modifier', 'h', 'forgot/secret.tpl', 39, false),array('modifier', 'sfGetErrorColor', 'forgot/secret.tpl', 47, false),)), $this); ?>
...
：&nbsp;<!--★答え入力★-->
			<input type="text" name="reminder_answer" value="" class="box300" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr']['reminder_answer'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
" /></p>
		...
		<div class="btn_area">
			<ul class="list-inline">
				<li><input type="submit" class="btn btn-default" value="次へ" name="next" id="next" />
			</ul>
		</div>
	</form>
</div>
