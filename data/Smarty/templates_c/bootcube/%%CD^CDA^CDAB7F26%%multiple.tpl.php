<?php /* Smarty version 2.6.27, created on 2014-11-11 16:33:32
         compiled from /var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 26, false),array('modifier', 'h', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 28, false),array('modifier', 'strlen', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 63, false),array('modifier', 'sfNoImageMainList', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 63, false),array('modifier', 'number_format', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 75, false),array('modifier', 'sfGetErrorColor', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 82, false),array('function', 'html_options', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/multiple.tpl', 111, false),)), $this); ?>

<div id="undercolumn">
	<div id="undercolumn_shopping">
		<p class="flow_area">
			<img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/picture/img_flow_01.jpg" class="img-responsive" alt="購入手続きの流れ" />
		</p>
...
" class="img-responsive" style="width: 90px;" alt="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['name']['value'][$this->_tpl_vars['index']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" /></a>
						</td>
...
<br />
							<?php endif; ?>
							<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['price_inctax']['value'][$this->_tpl_vars['index']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
円
						</td>
						<td>
...
" class="btn btn-default">戻る</a>
					...
					<li>
						<input type="submit" class="btn btn-primary box190" value="選択したお届け先に送る" name="send_button" id="send_button" />
					</li>
				</ul>
			</div>
		</form>
