<?php /* Smarty version 2.6.27, created on 2014-11-11 16:40:54
         compiled from /var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 39, false),array('modifier', 'h', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 40, false),array('modifier', 'strlen', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 84, false),array('modifier', 'sfNoImageMainList', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 84, false),array('modifier', 'number_format', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 101, false),array('modifier', 'default', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 117, false),array('modifier', 'regex_replace', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 230, false),array('modifier', 'nl2br', '/var/www/eccube/html/../data/Smarty/templates/bootcube/shopping/confirm.tpl', 357, false),)), $this); ?>
...
img/picture/img_flow_03.jpg" class="img-responsive" alt="購入手続きの流れ" /></p>
...
" />
			...
			<div class="btn_area">
				<ul class="list-inline">
					...
					<li>
						<input type="submit" onclick="return fnCheckSubmit();" class="btn btn-primary" value="次へ" name="next-top" id="next-top" />
					</li>
						<?php else: ?>
					<li>
						<input type="submit" onclick="return fnCheckSubmit();" class="btn btn-primary" value="ご注文完了ページへ" name="next-top" id="next-top" />
					</li>
					<?php endif; ?>
				</ul>
			</div>
...
" class="img-responsive" style="width: 90px;" alt="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['productsClass']['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" /></a>
						</td>
						<td>
...
円</span></td>
				...
				<table class="delivname table table-bordered" summary="ポイント確認">
				<col width="30%" />
				<col width="70%" />
					<tr>
...
Pt</td>
			...
			<?php endif; ?>
						...
						<h3 class="title">ご注文者</h3>
			<table class="customer table table-bordered" summary="ご注文者">
				<col width="30%" />
				<col width="70%" />
				<tbody>
					<tr>
...
?>
				<h3 class="title">お届け先<?php if (((is_array($_tmp=$this->_tpl_vars['is_multiple'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><?php echo ((is_array($_tmp=$this->_foreach['shippingItem']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
<?php endif; ?></h3>
...
円
				...
				<table class="delivname table table-bordered" summary="お届け先確認">
					<col width="30%" />
					<col width="70%" />
					<tbody>
						<tr>
...
-<?php echo ((is_array($_tmp=$this->_tpl_vars['shippingItem']['shipping_fax03'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
			...
			<h3 class="title">配送方法・お支払方法・その他お問い合わせ</h3>
			<table class="delivname table table-bordered" summary="配送方法・お支払方法・その他お問い合わせ">
				<col width="30%" />
				<col width="70%" />
				<tbody>
				<tr>
			...
			<div class="btn_area">
				<ul class="list-inline">
					...
					<?php if (((is_array($_tmp=$this->_tpl_vars['use_module'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
					<li>
						<input type="submit" onclick="return fnCheckSubmit();" class="btn btn-primary" value="次へ" name="next" id="next" />
					</li>
					<?php else: ?>
					<li>
						<input type="submit" onclick="return fnCheckSubmit();" class="btn btn-primary" value="ご注文完了ページへ" name="next" id="next" />
					</li>
					<?php endif; ?>
				</ul>
			</div>
