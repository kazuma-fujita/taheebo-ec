...
forgot/<?php echo ((is_array($_tmp=@DIR_INDEX_PATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
','forget','600','460',{scrollbars:'no',resizable:'no'}); return false;" target="_blank"><input type="button" class="btn btn-default fs18" value="パスワードを忘れた" name="log" id="log" />
                                                        </a>
						    </li>
						</div>
					</div>
...
entry/kiyaku.php" class="btn btn-danger fs24" style="padding:15px;">新規会員登録をする</a>
							</div>
						</div>
					</div>
				</div>
