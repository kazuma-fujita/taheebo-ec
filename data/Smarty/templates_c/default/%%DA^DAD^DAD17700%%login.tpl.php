<?php /* Smarty version 2.6.27, created on 2014-12-03 00:17:47
         compiled from mypage/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mypage/login.tpl', 4, false),array('modifier', 'h', 'mypage/login.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'mypage/login.tpl', 31, false),array('modifier', 'sfGetChecked', 'mypage/login.tpl', 33, false),)), $this); ?>
...
"><div class="login_area">
                ...
                <div class="inputbox">
                    <dl class="formlist clearfix"><?php $this->assign('key', 'login_email'); ?><dt>メールアドレス ：</dt>
                        <dd>
...
" value="1" <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_login_memory'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetChecked', true, $_tmp, 1) : SC_Utils_Ex::sfGetChecked($_tmp, 1)); ?>
 id="login_memory"><label for="login_memory">メールアドレスをコンピューターに記憶させる</label>
                            </p>
                        </dd>
                    </dl><dl class="formlist clearfix"><?php $this->assign('key', 'login_pass'); ?><dt>
                            パスワード ：
                        </dt>
                        <dd>
                            <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
img/button/btn_login.jpg" alt="ログイン" name="log" id="log"></li>
                        </ul></div>
                </div>
                <p>
...
img/button/btn_entry.jpg" alt="会員登録をする"></a>
                            </li>
                        </ul></div>
                </div>
            </div>
