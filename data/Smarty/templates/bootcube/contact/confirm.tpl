...
<div id="undercolumn">
	<div id="undercolumn_contact">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<!--{$smarty.const.ROOT_URLPATH}-->contact/index.php">お問い合わせ</a></li>
		...
		<form name="form1" id="form1" method="post" action="?">
			...
			<!--{foreach key=key item=item from=$arrForm}-->
				...
				<!--{/if}-->
			<!--{/foreach}-->
			<table class="table table-bordered" summary="お問い合わせ内容確認">
				<col width="30%" />
				<col width="70%" />
				<tr>
					<th>お名前</th>
			...
			<div class="btn_area">
				<ul class="list-inline">
					...
					<li>
						<input type="submit" class="btn btn-primary" value="完了ページへ" name="send" id="send" />
					</li>
				</ul>
			</div>
