<div class="block_outer col-xs-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
	<div id="bc_sidelogin">
		...
		<div class="content_panel">
			<form class="form" name="login_form" id="login_form" method="post" action="<!--{$smarty.const.HTTPS_URL}-->frontparts/login_check.php"<!--{if $tpl_login}--> onsubmit="return eccube.checkLoginFormInputted('login_form')"<!--{/if}-->>
				...
				<div class="col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
					<img src="<!--{$TPL_URLPATH}-->img/taheebo/iinet_main_logo.png" class="img-responsive"/>
				</div>

				<div class="col-xs-12 col-sm-10 col-sm-offset-1"><h4 class="title">
					<span class="icon"><i class="fa fa-lock"></i></span>　ログイン</h4>
				</div>
