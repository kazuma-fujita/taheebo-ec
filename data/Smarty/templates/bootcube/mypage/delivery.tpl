				...
				<col width="10%" />
					...
					<!--{section name=cnt loop=$arrOtherDeliv}-->
						...
						<tr>
							...
							<td class="alignC">
								<a href="./delivery_addr.php" onclick="eccube.openWindow('./delivery_addr.php?other_deliv_id=<!--{$arrOtherDeliv[cnt].other_deliv_id}-->','deliv_disp','770','640'); return false;">変更</a>
							</td>
							<td class="alignC">
