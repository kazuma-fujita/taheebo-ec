        ...
        <!--{foreach key=key item=item from=$arrPaymentType}-->
            ...
            <a
                ...
                style="padding-right: 1em; margin-bottom: 1em;"
                    href="javascript:;"
                    onclick="document.form1.search_pageno.value='1'; fnModeSubmit('search','pay_id','<!--{$key}-->' ); return false;"
            ><!--{$item}--></a>
            <!--{else}-->
            <a
                class="btn-normal"
    ...
    <h2>決済状況 抽出条件</h2>
        ...
        <!--{foreach key=key item=item from=$arrPaymentStatus}-->
            ...
            <a
                ...
                style="padding-right: 1em; margin-bottom: 1em;"
                    href="javascript:;"
                    onclick="document.form1.search_pageno.value='1'; fnModeSubmit('search','pay_status','<!--{$key}-->' ); return false;"
            ><!--{$item}--></a>
            <!--{else}-->
            <a
                class="btn-normal"
