...
ADMIN_MAIL=${ADMIN_MAIL:-"info@taheebo-ec.net"}
SHOP_NAME=${SHOP_NAME:-"いいねっと"}
HTTP_URL=${HTTP_URL:-"http://taheebo-e.net/"}
HTTPS_URL=${HTTPS_URL:-"https://taheebo-e.net/"}
DOMAIN_NAME=${DOMAIN_NAME:-""}

DBSERVER=${DBSERVER-"localhost"}
DBNAME=${DBNAME:-"taheebo_db"}
DBUSER=${DBUSER:-"taheebo_user"}
DBPASS=${DBPASS:-"1qaz2wsx"}
...
"mysql" )
    ...
    echo "createdb..."
    ${MYSQL} -u ${ROOTUSER} ${PASSOPT} -e "create database ${DBNAME} CHARACTER SET utf8"
    #echo "grant user..."
